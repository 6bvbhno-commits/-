...
async def handle_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """يعالج أي رسالة نصية فيها رابط منتج (طويل أو مختصر)."""
    text = update.message.text.strip()

    # لو الرابط مختصر (amzn.to / a.co)، حلّه أول شي لمعرفة الرابط الحقيقي
    ...
    if not asin:
        await update.message.reply_text(
            ...
            "جرب تنسخ الرابط من شريط العنوان مباشرة بدل زر المشاركة، "
            "أو تأكد إنه رابط منتج فيه /dp/ أو /gp/product/"
        )
        return
